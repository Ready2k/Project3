...
def render_system_configuration() -> None:
    ...
    st.write(
        "Configure advanced system parameters for autonomy assessment, pattern matching, and recommendations."
    )
    ...
    try:
        ...
        st.warning(
            "This is a cached configuration issue. The system will automatically fix this."
        )
        ...
        try:
            ...
            st.error(
                "❌ Unable to fix configuration automatically. Please restart the application."
            )
            return
    ...
    with tab1:
        ...
        try:
            ...
            st.info(
                "Please refresh the page or use the Management tab to reset configuration."
            )
...
def render_autonomy_config(config: AutonomyConfig) -> None:
    ...
    with col1:
        ...
        config.min_autonomy_threshold = st.slider(
            ...
            min_value=0.0,
            max_value=1.0,
            value=config.min_autonomy_threshold,
            step=0.05,
        ...
        config.confidence_boost_factor = st.slider(
            ...
            min_value=1.0,
            max_value=2.0,
            value=config.confidence_boost_factor,
            step=0.1,
        ...
        config.fully_automatable_threshold = st.slider(
            ...
            min_value=0.0,
            max_value=1.0,
            value=config.fully_automatable_threshold,
            step=0.05,
        ...
        config.partially_automatable_threshold = st.slider(
            ...
            min_value=0.0,
            max_value=1.0,
            value=config.partially_automatable_threshold,
            step=0.05,
        ...
        config.agentic_necessity_threshold = st.slider(
            ...
            min_value=0.0,
            max_value=1.0,
            value=config.agentic_necessity_threshold,
            step=0.05,
        ...
        config.traditional_suitability_threshold = st.slider(
            ...
            min_value=0.0,
            max_value=1.0,
            value=config.traditional_suitability_threshold,
            step=0.05,
        ...
        config.hybrid_zone_threshold = st.slider(
            ...
            min_value=0.0,
            max_value=0.3,
            value=config.hybrid_zone_threshold,
            step=0.01,
    ...
    with col2:
        ...
        config.reasoning_capability_weight = st.slider(
            ...
            min_value=0.0,
            max_value=1.0,
            value=config.reasoning_capability_weight,
            step=0.05,
        ...
        config.decision_independence_weight = st.slider(
            ...
            min_value=0.0,
            max_value=1.0,
            value=config.decision_independence_weight,
            step=0.05,
        ...
        config.exception_handling_weight = st.slider(
            ...
            min_value=0.0,
            max_value=1.0,
            value=config.exception_handling_weight,
            step=0.05,
        ...
        config.learning_adaptation_weight = st.slider(
            ...
            min_value=0.0,
            max_value=1.0,
            value=config.learning_adaptation_weight,
            step=0.05,
        ...
        config.self_monitoring_weight = st.slider(
            ...
            min_value=0.0,
            max_value=1.0,
            value=config.self_monitoring_weight,
            step=0.05,
        ...
        # Show weight total
        current_total = (
            config.reasoning_capability_weight
            + config.decision_independence_weight
            + config.exception_handling_weight
            + config.learning_adaptation_weight
...
def render_pattern_matching_config(config: PatternMatchingConfig) -> None:
    ...
    with col1:
        ...
        config.confidence_weight = st.slider(
            ...
            min_value=0.0,
            max_value=1.0,
            value=config.confidence_weight,
            step=0.05,
    ...
    with col2:
        ...
        config.strong_tag_match_threshold = st.slider(
            ...
            min_value=0.0,
            max_value=1.0,
            value=config.strong_tag_match_threshold,
            step=0.05,
        ...
        config.high_similarity_threshold = st.slider(
            ...
            min_value=0.0,
            max_value=1.0,
            value=config.high_similarity_threshold,
            step=0.05,
        ...
        config.excellent_fit_threshold = st.slider(
            ...
            min_value=0.0,
            max_value=1.0,
            value=config.excellent_fit_threshold,
            step=0.05,
...
def render_recommendation_config(config: RecommendationConfig) -> None:
    ...
    with col1:
        ...
        config.min_recommendation_confidence = st.slider(
            ...
            min_value=0.0,
            max_value=1.0,
            value=config.min_recommendation_confidence,
            step=0.05,
        ...
        config.tech_stack_inclusion_threshold = st.slider(
            ...
            min_value=0.0,
            max_value=1.0,
            value=config.tech_stack_inclusion_threshold,
            step=0.05,
        ...
        config.new_pattern_creation_threshold = st.slider(
            ...
            min_value=0.0,
            max_value=1.0,
            value=config.new_pattern_creation_threshold,
            step=0.05,
    ...
    with col2:
        ...
        config.autonomy_boost_factor = st.slider(
            ...
            min_value=0.0,
            max_value=0.5,
            value=config.autonomy_boost_factor,
            step=0.05,
        ...
        config.reasoning_boost_amount = st.slider(
            ...
            min_value=0.0,
            max_value=0.3,
            value=config.reasoning_boost_amount,
            step=0.05,
        ...
        config.multi_agent_boost = st.slider(
            ...
            min_value=0.0,
            max_value=0.3,
            value=config.multi_agent_boost,
            step=0.05,
...
def render_rate_limiting_config(config: Any) -> None:
    ...
    st.info(
        "Configure rate limits to prevent API abuse while allowing normal Q&A interactions."
    )
    ...
    with col1:
        ...
        config.default_requests_per_minute = st.number_input(
            ...
            min_value=10,
            max_value=500,
            value=config.default_requests_per_minute,
        ...
        config.default_requests_per_hour = st.number_input(
            ...
            min_value=100,
            max_value=5000,
            value=config.default_requests_per_hour,
        ...
        config.default_requests_per_day = st.number_input(
            ...
            min_value=1000,
            max_value=50000,
            value=config.default_requests_per_day,
        ...
        config.default_burst_limit = st.number_input(
            ...
            min_value=5,
            max_value=100,
            value=config.default_burst_limit,
        ...
        config.default_burst_window_seconds = st.number_input(
            ...
            min_value=30,
            max_value=300,
            value=config.default_burst_window_seconds,
    ...
    with col2:
        ...
        config.premium_requests_per_minute = st.number_input(
            ...
            min_value=50,
            max_value=1000,
            value=config.premium_requests_per_minute,
        ...
        config.premium_burst_limit = st.number_input(
            ...
            min_value=20,
            max_value=200,
            value=config.premium_burst_limit,
        ...
        config.enterprise_requests_per_minute = st.number_input(
            ...
            min_value=100,
            max_value=2000,
            value=config.enterprise_requests_per_minute,
        ...
        config.enterprise_burst_limit = st.number_input(
            ...
            min_value=50,
            max_value=500,
            value=config.enterprise_burst_limit,
    ...
    if config.default_burst_limit < 15:
        st.warning(
            "⚠️ Low burst limit may cause issues with Q&A interactions. Consider increasing to 20+."
        )
    elif config.default_burst_limit >= 25:
        st.success("✅ Burst limit is sufficient for smooth Q&A interactions.")
    else:
        st.info(
            "ℹ️ Burst limit is adequate but could be higher for better user experience."
        )
    ...
    with st.expander("📊 Rate Limiting Scenarios"):
        ...
        st.write(
            f"- **Current burst limit: {config.default_burst_limit} requests** ✅"
            if config.default_burst_limit >= 10
            else f"- **Current burst limit: {config.default_burst_limit} requests** ⚠️"
        )
...
def render_configuration_management(config_manager: SystemConfigurationManager) -> None:
    ...
    with col1:
        if st.button("💾 Save Configuration", width="stretch", key="save_config_btn"):
    ...
    with col2:
        if st.button("🔄 Reset to Defaults", width="stretch", key="reset_config_btn"):
    ...
    with col3:
        if st.button(
            "📤 Export Configuration", width="stretch", key="export_config_btn"
        ):
    ...
    with st.expander("📋 Current Configuration Preview"):
        st.code(
            yaml.dump(
                config_manager.export_config(), default_flow_style=False, indent=2
            ),
            language="yaml",
        )
...
def render_api_endpoints() -> None:
    ...
    st.write(
        "Explore and test the AAA system API endpoints directly from your browser."
    )
    ...
    for endpoint in health_endpoints:
        ...
        with col3:
            ...
            st.link_button("🔗 Open", full_url, width="stretch")
    ...
    with col1:
        ...
        if st.button("🏥 Test Basic Health", width="stretch"):
            try:
                import requests
...
def render_audit_database_management():
    ...
    try:
        ...
        with sqlite3.connect(audit_logger.db_path) as conn:
            ...
            cursor = conn.execute(
                "SELECT MIN(created_at), MAX(created_at) FROM runs WHERE created_at IS NOT NULL"
            )
...
def render_audit_data_viewer(audit_logger):
    ...
    table_option = st.selectbox(
        "Select Table", ["LLM Calls (runs)", "Pattern Matches (matches)"]
    )
    ...
    with col1:
        limit = st.number_input(
            "Limit Results", min_value=10, max_value=1000, value=100
        )
    with col2:
        ...
        try:
            if table_option == "LLM Calls (runs)":
                ...
                if not df.empty:
                    ...
                    if st.checkbox("Enable bulk delete", key="enable_bulk_delete_runs"):
                        ...
                        if selected_ids and st.button(
                            ...
                            type="secondary",
                            key="delete_selected_runs_btn",
                        ):
                            if st.checkbox(
                                "I confirm I want to delete these records",
                                key="confirm_delete_selected_runs",
                            ):
                                with sqlite3.connect(audit_logger.db_path) as conn:
                ...
                if not df.empty:
                    ...
                    # Bulk delete option
                    if st.checkbox(
                        "Enable bulk delete", key="enable_bulk_delete_matches"
                    ):
                        selected_ids = st.multiselect(
                            "Select records to delete",
                            options=df["id"].tolist(),
                        ...
                        if selected_ids and st.button(
                            "🗑️ Delete Selected Records",
                            type="secondary",
                            key="delete_selected_matches_btn",
                        ):
                            if st.checkbox(
                                "I confirm I want to delete these records",
                                key="confirm_delete_selected_matches",
                            ):
                                with sqlite3.connect(audit_logger.db_path) as conn:
                                    placeholders = ",".join(["?" for _ in selected_ids])
                                    cursor = conn.execute(
...
def render_audit_cleanup(audit_logger):
    ...
    with col1:
        ...
        days_to_keep = st.number_input(
            "Keep records newer than (days)", min_value=1, max_value=365, value=30
        )

        if st.button(
            "🗑️ Clean Old Records", type="secondary", key="clean_old_audit_records_btn"
        ):
            if st.checkbox(
                "I confirm I want to delete old records",
                key="confirm_clean_old_audit_records",
            ):
                try:
                    deleted_count = audit_logger.cleanup_old_records(days=days_to_keep)
                    st.success(
                        f"✅ Deleted {deleted_count} old records (older than {days_to_keep} days)"
                    )
                except Exception as e:
    ...
    with col2:
        ...
        if st.button(
            "🗑️ Clean Test Data", type="secondary", key="clean_test_audit_data_btn"
        ):
            if st.checkbox(
                "I confirm I want to delete test data",
                key="confirm_clean_test_audit_data",
            ):
                try:
                    with sqlite3.connect(audit_logger.db_path) as conn:
                    ...
                    st.success(
                        f"✅ Deleted {total_deleted} test records (runs: {runs_deleted}, matches: {matches_deleted})"
                    )
                except Exception as e:
    ...
    with st.expander("🚨 Complete Database Reset"):
        st.warning(
            "This will delete ALL data in the audit database. This action cannot be undone!"
        )

        if (
            st.text_input(
                "Type 'DELETE ALL DATA' to confirm",
                key="confirm_delete_all_audit_input",
            )
            == "DELETE ALL DATA"
        ):
            if st.button(
                ...
                try:
                    ...
                    st.success(
                        f"✅ Deleted ALL data: {runs_deleted} runs, {matches_deleted} matches"
                    )
                    st.rerun()
                except Exception as e:
...
def render_security_database_management():
    ...
    try:
        ...
        with sqlite3.connect(security_logger.db_path) as conn:
            ...
            cursor = conn.execute(
                "SELECT MIN(timestamp), MAX(timestamp) FROM security_events WHERE timestamp IS NOT NULL"
            )
            date_range = cursor.fetchone()
        ...
        tab1, tab2, tab3 = st.tabs(
            ["🔍 View Events", "📊 Security Analytics", "🗑️ Cleanup"]
        )
            ...
            if not df.empty:
                ...
                st.dataframe(
                    ...
                    column_config={
                        ...
                        "processing_time_ms": st.column_config.NumberColumn(
                            "Processing Time (ms)", format="%.1f"
                        ),
                    },
                )
                ...
                # Event details
                if st.checkbox(
                    "Show detailed event information", key="show_security_event_details"
                ):
                    ...
                    if selected_event_id:
                        ...
                        with col1:
                            ...
                            st.write(
                                f"**Alert Severity:** {event_row['alert_severity']}"
                            )
                            st.write(
                                f"**Progressive Level:** {event_row['progressive_response_level']}"
                            )

                        with col2:
                            st.write(f"**Input Length:** {event_row['input_length']}")
                            st.write(
                                f"**Processing Time:** {event_row['processing_time_ms']:.1f}ms"
                            )
                            ...
                            if event_row["input_preview"]:
                                ...
                                st.text_area(
                                    "",
                                    value=event_row["input_preview"],
                                    height=100,
                                    disabled=True,
                                    key="security_event_input_preview",
                                )
                        ...
                        if event_row["detected_attacks"]:
                            ...
                            if attacks:
                                ...
                                for i, attack in enumerate(attacks):
                                    st.write(
                                        f"{i+1}. **{attack.get('name', 'Unknown')}** ({attack.get('category', 'Unknown')})"
                                    )
                                    st.write(
                ...
                # Bulk delete option
                if st.checkbox(
                    "Enable bulk delete", key="enable_bulk_delete_security_events"
                ):
                    selected_ids = st.multiselect(
                    ...
                    if selected_ids and st.button(
                        ...
                        type="secondary",
                        key="delete_selected_security_events_btn",
                    ):
                        if st.checkbox(
                            "I confirm I want to delete these security events",
                            key="confirm_delete_selected_security_events",
                        ):
                            with sqlite3.connect(security_logger.db_path) as conn:
                                placeholders = ",".join(["?" for _ in selected_ids])
                                cursor = conn.execute(
                                    f"DELETE FROM security_events WHERE id IN ({placeholders})",
                                    selected_ids,
                                )
                                deleted_count = cursor.rowcount
                                conn.commit()
    ...
    try:
        with sqlite3.connect(security_logger.db_path) as conn:
            ...
            if not action_df.empty:
                st.dataframe(
                    ...
                    column_config={
                        ...
                        "avg_processing_time": st.column_config.NumberColumn(
                            "Avg Processing Time (ms)", format="%.1f"
                        ),
                    },
                )
            ...
            if not recent_df.empty:
                ...
                pivot_df = recent_df.pivot(
                    index="date", columns="action", values="count"
                ).fillna(0)
...
def render_security_cleanup(security_logger):
    ...
    with col1:
        ...
        days_to_keep = st.number_input(
            "Keep events newer than (days)", min_value=1, max_value=365, value=90
        )

        if st.button(
            "🗑️ Clean Old Security Events",
            type="secondary",
            key="clean_old_security_events_btn",
        ):
            if st.checkbox(
                "I confirm I want to delete old security events",
                key="confirm_clean_old_security_events",
            ):
                try:
                    ...
                    with sqlite3.connect(security_logger.db_path) as conn:
                        ...
                        cursor = conn.execute(
                            "DELETE FROM security_metrics WHERE timestamp < ?",
                            (cutoff_date,),
                        )
                    ...
                    st.success(
                        f"✅ Deleted {events_deleted} old events and {metrics_deleted} old metrics (older than {days_to_keep} days)"
                    )
                except Exception as e:
    ...
    with col2:
        ...
        severity_to_clean = st.selectbox(
            "Clean events with severity", ["low", "medium", "high", "critical"]
        )

        if st.button(
            f"🗑️ Clean {severity_to_clean.title()} Severity Events",
            type="secondary",
            key="clean_severity_events_btn",
        ):
            if st.checkbox(
                f"I confirm I want to delete all {severity_to_clean} severity events",
                key="confirm_clean_severity_events",
            ):
                try:
                    with sqlite3.connect(security_logger.db_path) as conn:
                        cursor = conn.execute(
                            "DELETE FROM security_events WHERE alert_severity = ?",
                            (severity_to_clean,),
                        )
                        deleted_count = cursor.rowcount
                        conn.commit()
                    ...
                    st.success(
                        f"✅ Deleted {deleted_count} {severity_to_clean} severity events"
                    )
                except Exception as e:
    ...
    with st.expander("🚨 Complete Security Database Reset"):
        st.warning(
            "This will delete ALL data in the security database. This action cannot be undone!"
        )

        if (
            st.text_input(
                "Type 'DELETE ALL SECURITY DATA' to confirm",
                key="confirm_delete_all_security_input",
            )
            ...
            if st.button(
                "🚨 DELETE ALL SECURITY DATA",
                type="secondary",
                key="delete_all_security_data_btn",
            ):
                try:
                    with sqlite3.connect(security_logger.db_path) as conn:
                    ...
                    st.success(
                        f"✅ Deleted ALL security data: {events_deleted} events, {metrics_deleted} metrics"
                    )
                    st.rerun()
                except Exception as e:
