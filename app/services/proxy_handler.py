...
class ProxyHandler:
    ...
    def validate_proxy_config(self) -> ProxyValidationResult:
        ...
        if not self.proxy_url:
            return ProxyValidationResult(
                is_valid=True,
                error_message="No proxy configured"
            )
    ...
    async def test_proxy_connectivity(self, test_url: str = "https://httpbin.org/ip", timeout: int = 10) -> ProxyTestResult:
    ...
    def get_proxy_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "username": self.proxy_config.username if self.proxy_config.username else None,
