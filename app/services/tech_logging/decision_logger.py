...
class DecisionLogger:
    ...
    def add_decision_criteria(
        ...
        self.logger.log_debug(
            ...
            {"decision_id": decision_id, "criteria": [asdict(c) for c in criteria]},
        )

    def log_option_evaluation(
        self, decision_id: str, evaluation: OptionEvaluation
    ) -> None:
        """
    ...
    def complete_decision(
        self, decision_id: str, result: DecisionResult
    ) -> DecisionTrace:
        """
        ...
        self.logger.log_info(
            ...
            f"Technology selection completed: {len(selected_technologies)} selected",
            {
                ...
                "selection_stats": {
                    ...
                    "explicit_selected": len(
                        [t for t in selected_technologies if t in explicit_technologies]
                    ),
                    "contextual_selected": len(
                        [
                            t
                            for t in selected_technologies
                            if t in contextual_technologies
                        ]
                    ),
    ...
    def get_decision_summary(
        self, component: Optional[str] = None, decision_type: Optional[str] = None
    ) -> Dict[str, Any]:
        """
        ...
        decision_entries = self.logger.get_log_entries(
            category=LogCategory.DECISION_MAKING, component=component
        )
