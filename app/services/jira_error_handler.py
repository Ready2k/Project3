...
class JiraErrorHandler:
    ...
    def detect_error_type(self, error_message: str, status_code: Optional[int] = None, 
                         exception: Optional[Exception] = None) -> JiraErrorType:
        """
    ...
    def create_error_detail(self, error_message: str, status_code: Optional[int] = None,
                           exception: Optional[Exception] = None, 
                           technical_details: Optional[str] = None) -> JiraErrorDetail:
        """
...
def create_jira_error_handler(deployment_type: Optional[JiraDeploymentType] = None) -> JiraErrorHandler:
