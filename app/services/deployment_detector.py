...
class DeploymentDetector:
    ...
    def __init__(self, timeout: int = 30, verify_ssl: bool = True, ca_cert_path: Optional[str] = None, proxy_url: Optional[str] = None):
    ...
    async def detect_deployment(self, base_url: str, auth_headers: Optional[Dict[str, str]] = None) -> DeploymentInfo:
    ...
    async def _get_version_info(self, base_url: str, auth_headers: Optional[Dict[str, str]] = None) -> VersionInfo:
    ...
    def _detect_from_version_info(self, version_info: VersionInfo) -> JiraDeploymentType:
