...
class APITokenHandler(AuthenticationHandler):
    ...
    def validate_config(self, config: JiraConfig) -> bool:
        ...
        """
        return (
            hasattr(config, "email")
            and config.email is not None
            and hasattr(config, "api_token")
    ...
    async def authenticate(self, config: JiraConfig) -> AuthResult:
        ...
        try:
            ...
            self.logger.info(
                f"API token authentication configured for email: {config.email}"
            )
...
class PATHandler(AuthenticationHandler):
    ...
    def validate_config(self, config: JiraConfig) -> bool:
        ...
        """
        return (
            hasattr(config, "personal_access_token")
            and config.personal_access_token is not None
        )
...
class SSOAuthHandler(AuthenticationHandler):
    ...
    def validate_config(self, config: JiraConfig) -> bool:
        ...
        return (hasattr(config, "use_sso") and config.use_sso is True) or (
            hasattr(config, "sso_session_cookie")
            and config.sso_session_cookie is not None
        )
    ...
    async def authenticate(self, config: JiraConfig) -> AuthResult:
        ...
        try:
            ...
            if hasattr(config, "sso_session_cookie") and config.sso_session_cookie:
                ...
                self.logger.info(
                    "SSO authentication configured - session detection not yet implemented"
                )
...
class BasicAuthHandler(AuthenticationHandler):
    ...
    async def authenticate(self, config: JiraConfig) -> AuthResult:
        ...
        try:
            ...
            self.logger.info(
                f"Basic authentication configured for username: {config.username}"
            )
