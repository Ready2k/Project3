...
from .base import (
    ExplicitTech,
    ExtractionMethod,
    TechnologyExtractor as BaseTechnologyExtractor,
)
...
class TechnologyExtractor(BaseTechnologyExtractor):
    ...
    def _init_technology_aliases(self) -> None:
        ...
        self.technology_aliases = {
            ...
            "amazon connect": TechnologyAlias(
                "amazon connect",
                "Amazon Connect",
                0.95,
                category="communication",
            ...
            "amazon connect sdk": TechnologyAlias(
                "amazon connect sdk",
                "Amazon Connect SDK",
                0.95,
                category="sdk",
            ...
            "s3": TechnologyAlias(
                "s3", "Amazon S3", 0.9, category="storage", ecosystem="aws"
            ),
            "simple storage service": TechnologyAlias(
            ...
            "aws lambda": TechnologyAlias(
                "aws lambda", "AWS Lambda", 0.95, category="compute", ecosystem="aws"
            ),
            "comprehend": TechnologyAlias(
                "comprehend", "AWS Comprehend", 0.9, category="ai", ecosystem="aws"
            ),
            "aws comprehend": TechnologyAlias(
                "aws comprehend", "AWS Comprehend", 0.95, category="ai", ecosystem="aws"
            ),
            "bedrock": TechnologyAlias(
                "bedrock", "AWS Bedrock", 0.9, category="ai", ecosystem="aws"
            ),
            "aws bedrock": TechnologyAlias(
                "aws bedrock", "AWS Bedrock", 0.95, category="ai", ecosystem="aws"
            ),
            "dynamodb": TechnologyAlias(
                "dynamodb", "Amazon DynamoDB", 0.9, category="database", ecosystem="aws"
            ),
            "dynamo db": TechnologyAlias(
                "dynamo db",
                "Amazon DynamoDB",
                0.9,
                category="database",
            ...
            "rds": TechnologyAlias(
                "rds", "Amazon RDS", 0.9, category="database", ecosystem="aws"
            ),
            "relational database service": TechnologyAlias(
            ...
            "ec2": TechnologyAlias(
                "ec2", "Amazon EC2", 0.9, category="compute", ecosystem="aws"
            ),
            "elastic compute cloud": TechnologyAlias(
            ...
            "ecs": TechnologyAlias(
                "ecs", "Amazon ECS", 0.9, category="container", ecosystem="aws"
            ),
            "elastic container service": TechnologyAlias(
            ...
            "eks": TechnologyAlias(
                "eks", "Amazon EKS", 0.9, category="container", ecosystem="aws"
            ),
            "elastic kubernetes service": TechnologyAlias(
            ...
            "sns": TechnologyAlias(
                "sns", "Amazon SNS", 0.9, category="messaging", ecosystem="aws"
            ),
            "simple notification service": TechnologyAlias(
            ...
            "sqs": TechnologyAlias(
                "sqs", "Amazon SQS", 0.9, category="messaging", ecosystem="aws"
            ),
            "simple queue service": TechnologyAlias(
            ...
            "cloudfront": TechnologyAlias(
                "cloudfront", "Amazon CloudFront", 0.9, category="cdn", ecosystem="aws"
            ),
            "cloud front": TechnologyAlias(
                "cloud front", "Amazon CloudFront", 0.9, category="cdn", ecosystem="aws"
            ),
            "route 53": TechnologyAlias(
                "route 53", "Amazon Route 53", 0.9, category="dns", ecosystem="aws"
            ),
            "route53": TechnologyAlias(
                "route53", "Amazon Route 53", 0.9, category="dns", ecosystem="aws"
            ),
            # Azure Services
            "cognitive services": TechnologyAlias(
                "cognitive services",
            ...
            "azure cognitive services": TechnologyAlias(
                "azure cognitive services",
                "Azure Cognitive Services",
                0.95,
                category="ai",
            ...
            "azure app service": TechnologyAlias(
                "azure app service",
                "Azure App Service",
                0.95,
                category="compute",
            ...
            "azure functions": TechnologyAlias(
                "azure functions",
                "Azure Functions",
                0.95,
                category="compute",
            ...
            "azure cosmos db": TechnologyAlias(
                "azure cosmos db",
                "Azure Cosmos DB",
                0.95,
                category="database",
            ...
            "azure sql database": TechnologyAlias(
                "azure sql database",
                "Azure SQL Database",
                0.95,
                category="database",
            ...
            "storage account": TechnologyAlias(
                "storage account",
            ...
            "azure blob storage": TechnologyAlias(
                "azure blob storage",
                "Azure Blob Storage",
                0.95,
                category="storage",
            ...
            "azure service bus": TechnologyAlias(
                "azure service bus",
                "Azure Service Bus",
                0.95,
                category="messaging",
            ...
            "azure event hubs": TechnologyAlias(
                "azure event hubs",
                "Azure Event Hubs",
                0.95,
                category="messaging",
            ...
            # GCP Services
            "cloud functions": TechnologyAlias(
                "cloud functions",
            ...
            "google cloud functions": TechnologyAlias(
                "google cloud functions",
                "Google Cloud Functions",
                0.95,
                category="compute",
            ...
            "google cloud run": TechnologyAlias(
                "google cloud run",
                "Google Cloud Run",
                0.95,
                category="compute",
            ...
            "bigquery": TechnologyAlias(
                "bigquery", "Google BigQuery", 0.9, category="database", ecosystem="gcp"
            ),
            "big query": TechnologyAlias(
                "big query",
                "Google BigQuery",
                0.9,
                category="database",
            ...
            "google bigquery": TechnologyAlias(
                "google bigquery",
                "Google BigQuery",
                0.95,
                category="database",
            ...
            "google firestore": TechnologyAlias(
                "google firestore",
                "Google Firestore",
                0.95,
                category="database",
            ...
            "google cloud storage": TechnologyAlias(
                "google cloud storage",
                "Google Cloud Storage",
                0.95,
                category="storage",
            ...
            "gcs": TechnologyAlias(
                "gcs", "Google Cloud Storage", 0.9, category="storage", ecosystem="gcp"
            ),
            "compute engine": TechnologyAlias(
                "compute engine",
            ...
            "google compute engine": TechnologyAlias(
                "google compute engine",
                "Google Compute Engine",
                0.95,
                category="compute",
            ...
            "gce": TechnologyAlias(
                "gce", "Google Compute Engine", 0.9, category="compute", ecosystem="gcp"
            ),
            "gke": TechnologyAlias(
                "gke",
            ...
            "google kubernetes engine": TechnologyAlias(
                "google kubernetes engine",
                "Google Kubernetes Engine",
                0.95,
                category="container",
            ...
            "google cloud pub/sub": TechnologyAlias(
                "google cloud pub/sub",
                "Google Cloud Pub/Sub",
                0.95,
                category="messaging",
            ...
            "javascript": TechnologyAlias(
                "javascript", "JavaScript", 0.95, category="language"
            ),
            "ts": TechnologyAlias("ts", "TypeScript", 0.8, category="language"),
            "typescript": TechnologyAlias(
                "typescript", "TypeScript", 0.95, category="language"
            ),
            ...
            "angularjs": TechnologyAlias(
                "angularjs", "AngularJS", 0.9, category="frontend"
            ),
            ...
            "express": TechnologyAlias(
                "express", "Express.js", 0.8, category="backend"
            ),
            "expressjs": TechnologyAlias(
                "expressjs", "Express.js", 0.9, category="backend"
            ),
            "express.js": TechnologyAlias(
                "express.js", "Express.js", 0.95, category="backend"
            ),
            "spring": TechnologyAlias(
                "spring", "Spring Framework", 0.8, category="backend"
            ),
            "spring boot": TechnologyAlias(
                "spring boot", "Spring Boot", 0.9, category="backend"
            ),
            "springboot": TechnologyAlias(
                "springboot", "Spring Boot", 0.9, category="backend"
            ),
            ...
            "ruby on rails": TechnologyAlias(
                "ruby on rails", "Ruby on Rails", 0.95, category="backend"
            ),
            "asp.net": TechnologyAlias("asp.net", "ASP.NET", 0.9, category="backend"),
            "aspnet": TechnologyAlias("aspnet", "ASP.NET", 0.9, category="backend"),
            "asp.net core": TechnologyAlias(
                "asp.net core", "ASP.NET Core", 0.95, category="backend"
            ),
            # Databases
            "postgres": TechnologyAlias(
                "postgres", "PostgreSQL", 0.9, category="database"
            ),
            "postgresql": TechnologyAlias(
                "postgresql", "PostgreSQL", 0.95, category="database"
            ),
            ...
            "elasticsearch": TechnologyAlias(
                "elasticsearch", "Elasticsearch", 0.9, category="search"
            ),
            "elastic": TechnologyAlias(
                "elastic", "Elasticsearch", 0.7, category="search"
            ),
            "elastic search": TechnologyAlias(
                "elastic search", "Elasticsearch", 0.9, category="search"
            ),
            "cassandra": TechnologyAlias(
                "cassandra", "Apache Cassandra", 0.9, category="database"
            ),
            "apache cassandra": TechnologyAlias(
                "apache cassandra", "Apache Cassandra", 0.95, category="database"
            ),
            "couchdb": TechnologyAlias(
                "couchdb", "Apache CouchDB", 0.9, category="database"
            ),
            "couch db": TechnologyAlias(
                "couch db", "Apache CouchDB", 0.9, category="database"
            ),
            "sqlite": TechnologyAlias("sqlite", "SQLite", 0.9, category="database"),
            "mariadb": TechnologyAlias("mariadb", "MariaDB", 0.9, category="database"),
            "oracle": TechnologyAlias(
                "oracle",
                "Oracle Database",
                0.8,
                context_required=True,
            ...
            "oracle db": TechnologyAlias(
                "oracle db", "Oracle Database", 0.9, category="database"
            ),
            "oracle database": TechnologyAlias(
                "oracle database", "Oracle Database", 0.95, category="database"
            ),
            "sql server": TechnologyAlias(
                "sql server", "Microsoft SQL Server", 0.9, category="database"
            ),
            "mssql": TechnologyAlias(
                "mssql", "Microsoft SQL Server", 0.9, category="database"
            ),
            "microsoft sql server": TechnologyAlias(
            ...
            "kubernetes": TechnologyAlias(
                "kubernetes", "Kubernetes", 0.95, category="orchestration"
            ),
            "kube": TechnologyAlias(
                "kube", "Kubernetes", 0.8, category="orchestration"
            ),
            "podman": TechnologyAlias("podman", "Podman", 0.9, category="container"),
            "containerd": TechnologyAlias(
                "containerd", "containerd", 0.9, category="container"
            ),
            "docker compose": TechnologyAlias(
                "docker compose", "Docker Compose", 0.9, category="orchestration"
            ),
            "docker-compose": TechnologyAlias(
                "docker-compose", "Docker Compose", 0.9, category="orchestration"
            ),
            ...
            "linkerd": TechnologyAlias(
                "linkerd", "Linkerd", 0.9, category="service-mesh"
            ),
            ...
            "transformers": TechnologyAlias(
                "transformers", "Hugging Face Transformers", 0.8
            ),
            ...
            "apache": TechnologyAlias(
                "apache", "Apache HTTP Server", 0.8, context_required=True
            ),
    ...
    def _init_extraction_patterns(self) -> None:
        ...
        self.tech_name_patterns = [
            ...
            re.compile(
                r"\b(?:fastapi|django|flask|react|vue\.js|angular|docker|kubernetes|redis|postgresql|mysql|mongodb|python|javascript|typescript|java|golang|rust|php|ruby|scala|kotlin|swift|dart|elixir|erlang|haskell|clojure|f#|c\+\+|c#|\.net|node\.js|express\.js|spring|hibernate|laravel|symfony|rails|asp\.net)\b",
                re.IGNORECASE,
            ),
            # Cloud services with prefixes (enhanced patterns)
            re.compile(
                r"\b(?:amazon|aws)\s+([\w\s]+?)(?:\s+(?:service|api|sdk|platform|engine|database|storage|compute|function|lambda|gateway|queue|notification|monitoring|analytics|ml|ai))?(?:\s|$|[,.])",
                re.IGNORECASE,
            ),
            re.compile(
                r"\b(?:azure|microsoft\s+azure)\s+([\w\s]+?)(?:\s+(?:service|api|sdk|platform|engine|database|storage|compute|function|app|gateway|queue|notification|monitoring|analytics|ml|ai))?(?:\s|$|[,.])",
                re.IGNORECASE,
            ),
            re.compile(
                r"\b(?:google\s+cloud|gcp)\s+([\w\s]+?)(?:\s+(?:service|api|sdk|platform|engine|database|storage|compute|function|app|gateway|queue|notification|monitoring|analytics|ml|ai))?(?:\s|$|[,.])",
                re.IGNORECASE,
            ),
            # Technology with common suffixes (enhanced)
            re.compile(
                r"\b([\w\-\.]+)\s+(?:api|sdk|library|framework|service|database|db|engine|platform|tool|client|driver|connector|adapter|plugin|extension|middleware|runtime|compiler|interpreter|vm|container|image|registry)\b",
                re.IGNORECASE,
            ),
            # Programming languages and runtimes (comprehensive)
            re.compile(
                r"\b(?:python|javascript|typescript|java|golang|go\s+lang|rust|php|ruby|scala|kotlin|swift|dart|elixir|erlang|haskell|clojure|f#|c\+\+|c#|\.net|node\.js|deno|bun)\b",
                re.IGNORECASE,
            ),
            # Framework and library patterns
            re.compile(
                r"\b([\w\-\.]+)\s+(?:framework|library|package|module|component|widget|plugin|extension|addon|toolkit|suite|stack|platform)\b",
                re.IGNORECASE,
            ),
            # Database and storage patterns
            re.compile(
                r"\b([\w\-\.]+)\s+(?:database|db|storage|cache|index|search|analytics|warehouse|lake|mart|store|repository|vault)\b",
                re.IGNORECASE,
            ),
            # Integration and communication patterns
            re.compile(
                r"\b([\w\-\.]+)\s+(?:integration|connector|client|driver|adapter|bridge|gateway|proxy|broker|queue|stream|pipeline|channel|protocol|interface)\b",
                re.IGNORECASE,
            ),
            # Monitoring and observability patterns
            re.compile(
                r"\b([\w\-\.]+)\s+(?:monitoring|logging|tracing|metrics|analytics|dashboard|alerting|notification|observability|telemetry)\b",
                re.IGNORECASE,
            ),
            # DevOps and deployment patterns
            re.compile(
                r"\b([\w\-\.]+)\s+(?:deployment|orchestration|automation|pipeline|ci\/cd|build|test|release|provisioning|configuration|infrastructure)\b",
                re.IGNORECASE,
            ),
            # Implicit technology references (e.g., "Connect SDK" -> "Amazon Connect SDK")
            re.compile(
                r"\b(connect|comprehend|bedrock|lambda|s3|ec2|rds|dynamodb|sns|sqs|cloudwatch|api\s+gateway|route\s+53)\s+(?:sdk|api|service|client|integration)?\b",
                re.IGNORECASE,
            ),
            # Version-specific patterns
            re.compile(
                r"\b([\w\-\.]+)\s+(?:v\d+|version\s+\d+|\d+\.\d+|\d+\.\d+\.\d+)\b",
                re.IGNORECASE,
            ),
            # Abbreviated technology names
            re.compile(
                r"\b(?:js|ts|py|k8s|tf|aws|gcp|az|db|api|ui|ux|ml|ai|nlp|cv|dl|rl)\b",
                re.IGNORECASE,
            ),
        ]
        ...
        self.context_patterns = {
            ...
            "database": re.compile(
                r"\b(?:database|db|storage|persistence)\b", re.IGNORECASE
            ),
            "api": re.compile(r"\b(?:api|rest|endpoint|service)\b", re.IGNORECASE),
            "ml": re.compile(
                r"\b(?:machine\s+learning|ai|model|training)\b", re.IGNORECASE
            ),
        ...
        self.ner_patterns = {
            ...
            "DATABASE": [re.compile(r"\b\w+(?:DB|SQL|Store|Base)\b", re.IGNORECASE)],
            "FRAMEWORK": [
    ...
    def extract_technologies(self, text: str) -> List[ExplicitTech]:
        ...
        self.logger.debug(
            f"Extracted {len(deduplicated)} technologies using multiple methods"
        )
        return deduplicated
    ...
    def resolve_aliases(self, tech_name: str) -> Optional[str]:
        ...
        for alias, mapping in self.technology_aliases.items():
            if alias in tech_lower or tech_lower in alias:
                ...
                if len(alias) >= 3 and (
                    len(alias) / len(tech_lower) >= 0.5
                    or len(tech_lower) / len(alias) >= 0.5
                ):
    ...
    def _calculate_similarity(self, str1: str, str2: str) -> float:
        ...
        similarity = (
            char_similarity * 0.4 + length_similarity * 0.3 + substring_similarity * 0.3
        )
    ...
    def calculate_extraction_confidence(
        ...
        if tech_lower in ambiguous_terms:
            ...
            if not any(ctx in context_lower for ctx in required_context):
                base_confidence *= (
                    0.6  # Significant reduction for ambiguous terms without context
                )
        ...
        for tech_key, context_keywords in tech_context_patterns.items():
            if tech_key in tech_lower:
                matching_keywords = sum(
                    1 for keyword in context_keywords if keyword in context_lower
                )
        ...
        if re.search(r"\d+(?:\.\d+)*", tech):
            base_confidence = min(
                base_confidence + 0.05, 1.0
            )  # Slight boost for versioned technologies

        # 6. Ecosystem consistency boost
        ecosystem_boost = self._calculate_ecosystem_consistency_boost(
            tech, context_lower
        )
    ...
    def _calculate_context_confidence_boosts(
        ...
        for category, keywords in category_contexts.items():
            if any(
                cat_word in tech_lower for cat_word in [category, category[:-1]]
            ):  # e.g., 'database' or 'databas'
                matching_keywords = sum(1 for keyword in keywords if keyword in context)
                if matching_keywords > 0:
                    boosts.append(
                        min(matching_keywords * 0.03, 0.1)
                    )  # Up to 10% boost per category

        # Specific technology mention patterns
        if any(
            pattern in context
            for pattern in ["using", "with", "via", "through", "integrate"]
        ):
            boosts.append(0.05)

        if any(
            pattern in context
            for pattern in ["implement", "build", "develop", "create"]
        ):
            boosts.append(0.03)
    ...
    def _calculate_ecosystem_consistency_boost(self, tech: str, context: str) -> float:
        ...
        for ecosystem, technologies in ecosystems.items():
            ...
            if any(eco_tech in tech_lower for eco_tech in technologies):
                ...
                other_techs_in_context = sum(
                    1
                    for eco_tech in technologies
    ...
    def _calculate_frequency_boost(self, tech: str, context: str) -> float:
        ...
        for alias, mapping in self.technology_aliases.items():
            if mapping.canonical_name.lower() == tech_lower and alias != tech_lower:
                alias_mentions = len(
                    re.findall(r"\b" + re.escape(alias) + r"\b", context)
                )
        ...
        if mentions > 1:
            return min(
                (mentions - 1) * 0.02, 0.08
            )  # Up to 8% boost for multiple mentions
        ...
        for alias, mapping in self.technology_aliases.items():
            ...
            for match in matches:
                ...
                confidence = self.calculate_extraction_confidence(
                    alias,
                    ExtractionMethod.ALIAS_RESOLUTION,
                ...
                for match in matches:
                    ...
                    if canonical_name:
                        ...
                        if self._looks_like_technology(entity_text, entity_type):
                            confidence = self._calculate_unknown_tech_confidence(
    ...
    def _looks_like_technology(self, text: str, entity_type: str) -> bool:
        ...
        if entity_type == "TECH_NAME":
            ...
            return (
                text[0].isupper()
                and not self._is_common_word(text)
                and text.lower() not in generic_terms
            )
    ...
    def _calculate_unknown_tech_confidence(
        ...
        for pattern_name, integration_pattern in self.integration_patterns.items():
            ...
            if pattern.search(text):
                ...
                context_scores = self._calculate_context_scores(
                    text_lower, integration_pattern.context_boost or {}
                )
                ...
                for tech_name in integration_pattern.technologies:
                    ...
                    confidence = (
                        base_confidence * integration_pattern.confidence_multiplier
                    )
                    ...
                    confidence = self._apply_ecosystem_boost(
                        tech_name, text_lower, confidence
                    )
    ...
    def _calculate_context_scores(
        self, text: str, context_boost: Dict[str, float]
    ) -> Dict[str, float]:
    ...
    def _apply_ecosystem_boost(
        self, tech_name: str, text: str, base_confidence: float
    ) -> float:
    ...
    def _has_relevant_context(self, alias: str, context: str) -> bool:
        ...
        context_requirements = {
            "lambda": [
                ...
                "amazon",
                "serverless",
            ],  # Removed 'function' to be more strict
            "functions": ["azure", "google", "cloud", "serverless"],
    ...
    def _deduplicate_and_enhance(
        self, technologies: List[ExplicitTech], text: str
    ) -> List[ExplicitTech]:
