    ...
    def _prepare_kwargs(self, kwargs: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if "max_tokens" in prepared_kwargs:
            ...
            if token_param == "max_completion_tokens":
                ...
                prepared_kwargs["max_completion_tokens"] = prepared_kwargs.pop(
                    "max_tokens"
                )
            ...
            try:
                ...
                if any(
                    ...
                    if retry_count <= max_retries:
                        ...
                        print(
                            f"⚠️ GPT-5 truncation detected, retrying with {new_tokens} tokens (attempt {retry_count})"
                        )
                        ...
                        print(
                            f"❌ GPT-5 truncation after {max_retries} retries, trying maximum tokens..."
                        )
                        ...
                        raise RuntimeError(
                            f"GPT-5 response consistently truncated. Try using a shorter prompt or breaking it into smaller parts. Original error: {e}"
                        )
