...
class TestPerformanceIntegration:
    ...
    async def test_validation_with_caching(self, defender_with_performance):
        ...
        test_input = (
            "This is a legitimate business automation request for invoice processing"
        )
    ...
    async def test_performance_metrics_accuracy(self, defender_with_performance):
        ...
        assert (
            metrics["validation_metrics"]["avg_latency_ms"] < 1000
        )  # Less than 1 second
    ...
    def test_performance_configuration_validation(self):
        ...
        assert any(
            "performance_alert_threshold_ms must be positive" in issue
            for issue in issues
        )
    ...
    async def test_memory_usage_monitoring(self, defender_with_performance):
        ...
        memory_alerts = [
            alert for alert in alerts_received if alert[0] == "high_memory_usage"
        ]
    ...
    async def test_cache_hit_rate_monitoring(self, defender_with_performance):
        ...
        cache_alerts = [
            alert for alert in alerts_received if alert[0] == "low_cache_hit_rate"
        ]
