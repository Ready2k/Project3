...
class TestEcosystemIntelligenceIntegration:
    ...
    def test_ecosystem_consistency_with_real_catalog(self, ecosystem_intelligence):
        ...
        assert (
            len(result.migration_options) >= 0
        )  # May or may not have migration options
    ...
    def test_integration_suggestions_with_real_catalog(self, ecosystem_intelligence):
        ...
        assert (
            IntegrationPattern.DATABASE_CONNECTION in integration_patterns
            or IntegrationPattern.CACHING in integration_patterns
        )
    ...
    def test_compatibility_analysis_with_real_catalog(self, ecosystem_intelligence):
        ...
        result = ecosystem_intelligence.check_technology_compatibility(
            "fastapi", "postgresql"
        )
        ...
        assert result.compatibility in [
            CompatibilityLevel.PROBLEMATIC,
            CompatibilityLevel.NEUTRAL,
        ]
    ...
    def test_migration_suggestions_with_real_catalog(self, ecosystem_intelligence):
        ...
        azure_migration = next(
            (m for m in migrations if "azure" in m.equivalent_tech.lower()), None
        )
    ...
    def test_context_aware_suggestions(self, ecosystem_intelligence):
        ...
        aws_suggestions = ecosystem_intelligence.suggest_integrations(
            "fastapi", aws_context
        )
    ...
    def test_integration_pattern_inference(self, ecosystem_intelligence):
        ...
        pattern = ecosystem_intelligence._infer_integration_pattern(
            "fastapi", "postgresql"
        )
...
class TestEcosystemIntelligenceWithTechStackGenerator:
    ...
    def test_ecosystem_analysis_integration(
        self, ecosystem_intelligence, mock_tech_stack_generator
    ):
        ...
        analysis = ecosystem_intelligence.analyze_technology_stack(
