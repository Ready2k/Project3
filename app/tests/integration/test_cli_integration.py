...
class TestCLIIntegration:
    ...
    @patch('app.services.catalog.intelligent_manager.IntelligentCatalogManager.__init__')
    ...
    def test_catalog_validate_command(self, mock_init, temp_catalog):
        ...
        assert ("✓ Catalog validation passed" in result.stdout or 
                "✗ Catalog validation failed" in result.stdout)
...
class TestCLIWithRealCatalog:
    ...
    def test_review_manager_import(self):
        ...
        try:
            from app.cli.review_manager import ReviewManagerCLI, create_parser
    ...
    def test_bulk_operations_import(self):
        ...
        try:
            from app.cli.bulk_operations import BulkOperationsCLI, create_parser
    ...
    def test_dashboard_import(self):
        ...
        try:
            from app.cli.catalog_dashboard import CatalogDashboard, create_parser
    ...
    def test_main_cli_import(self):
        ...
        try:
            from app.cli.main import create_parser, main
