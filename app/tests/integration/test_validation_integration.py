...
class TestValidationIntegration:
    ...
    def validator(self, catalog_manager):
        ...
        with patch('app.services.validation.compatibility_validator.require_service') as mock_require:
            ...
            validator = TechnologyCompatibilityValidator(catalog_manager=catalog_manager)
            return validator
    ...
    def test_end_to_end_validation_consistent_stack(self, validator):
        ...
        assert report.compatibility_result.ecosystem_result.primary_ecosystem == EcosystemType.OPEN_SOURCE
    ...
    def test_end_to_end_validation_conflicting_stack(self, validator):
        ...
        assert len(report.compatibility_result.ecosystem_result.mixed_ecosystem_technologies) > 0
    ...
    def test_database_conflict_resolution(self, validator):
        ...
        db_conflicts = [c for c in report.compatibility_result.conflicts 
    ...
    def test_compatibility_matrix_integration(self, validator):
        ...
        validator.add_compatibility_rule("FastAPI", "Django", 0.2, "Both are web frameworks")
        ...
        integration_conflicts = [c for c in report.compatibility_result.conflicts 
    ...
    def test_context_priority_influence(self, validator):
        ...
        if report_aws.compatibility_result.removed_technologies:
            assert "Azure Blob Storage" in report_aws.compatibility_result.removed_technologies
    ...
    def test_conflict_severity_handling(self, validator):
        ...
        critical_conflicts = report.compatibility_result.get_conflicts_by_severity(ConflictSeverity.CRITICAL)
    ...
    def test_compatibility_data_persistence(self, mock_json_dump, mock_open, validator):
        ...
        validator.add_compatibility_rule("PostgreSQL", "MySQL", 0.4, "Database conflict")
