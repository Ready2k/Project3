...
from app.services.jira import JiraConnectionError, JiraTicketNotFoundError, JiraError, ConnectionResult
...
class TestJiraTestEndpoint:
    ...
    def test_successful_cloud_connection(self, mock_service_class, client):
        ...
        mock_service.test_connection_with_fallback = AsyncMock(return_value=connection_result)
    ...
    def test_connection_failure(self, mock_service_class, client):
        ...
        # Mock auto-configuration
        mock_service.auto_configure = AsyncMock(side_effect=Exception("Auto-config failed"))
        ...
        assert "Verify the base URL is correct" in data["error_details"]["troubleshooting_steps"][0]
    ...
    def test_authentication_failure(self, mock_service_class, client):
        ...
        assert "Verify authentication credentials" in data["error_details"]["troubleshooting_steps"][0]
