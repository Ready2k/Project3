...
class TestFAISSIndex:
    ...
    async def test_add_documents_to_existing_index(
        self, fake_embedder, temp_index_path
    ):
        """Test adding documents to an existing index."""
        initial_texts = ["Initial document one", "Initial document two"]
        ...
        # Add more documents
        additional_texts = ["Additional document one", "Additional document two"]
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            for result in results:
                ...
                matched_patterns.append(
                    {**matched_pattern, "similarity_score": result["score"]}
                )
