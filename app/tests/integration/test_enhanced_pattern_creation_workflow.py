...
class TestEnhancedPatternCreationWorkflow:
    ...
    async def test_pattern_enhancement_with_catalog_intelligence(
        ...
        # Enhance pattern
        success, message, enhanced_pattern = (
            await pattern_enhancement_service.enhance_pattern(
    ...
    async def test_catalog_auto_addition_during_pattern_creation(
        ...
        with patch.object(
            pattern_creator.catalog_manager, "lookup_technology"
        ) as mock_lookup:
            with patch.object(
                pattern_creator.catalog_manager, "auto_add_technology"
            ) as mock_auto_add:
                # Simulate CustomTechStack not found in catalog
                mock_lookup.side_effect = lambda tech: (
                    None if tech == "CustomTechStack" else Mock()
                )
    ...
    async def test_ecosystem_consistency_validation(
        ...
        mixed_requirements["integrations"] = [
            "AWS Lambda",
            "Azure Functions",
    ...
    async def test_pattern_metadata_update_workflow(
        ...
        results = (
            pattern_enhancement_service.update_existing_patterns_with_enhanced_metadata()
        )
    ...
    def test_migration_script_integration(self, temp_pattern_dir):
        ...
        old_catalog = {
            ...
            "technologies": {
                "fastapi": {"name": "FastAPI", "description": "Modern web framework"},
                "django": {
                    "name": "Django",
    ...
    async def test_end_to_end_enhanced_workflow(
        ...
        success, message, enhanced_pattern = (
            await pattern_enhancement_service.enhance_pattern(pattern_id, "agentic")
        )
