            ...
            "content": [
                {
                    "type": "paragraph",
                    "content": [
                        {"type": "text", "text": "This is a test description with "},
...
class TestJiraAPIEndpoints:
    ...
    def test_jira_fetch_endpoint_success(self, client):
        ...
        with patch("app.services.jira.JiraService.fetch_ticket") as mock_fetch:
            ...
            with patch(
                "app.services.jira.JiraService.map_ticket_to_requirements"
            ) as mock_map:
                mock_requirements = {
    ...
    def test_jira_fetch_endpoint_ticket_not_found(self, client):
        ...
        with patch("app.services.jira.JiraService.fetch_ticket") as mock_fetch:
            mock_fetch.side_effect = JiraTicketNotFoundError(
                "Ticket 'NONEXISTENT-123' not found"
            )
