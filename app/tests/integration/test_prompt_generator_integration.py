...
class TestPromptGeneratorIntegration:
    ...
    def temp_catalog_path(self, tmp_path):
        ...
        catalog_data = {
            "metadata": {"version": "test", "total_technologies": 3},
            "technologies": {
                "fastapi": {
                    "id": "fastapi",
                    "name": "FastAPI",
    ...
    def test_full_workflow_with_explicit_technologies(
        self, requirement_parser, context_extractor, prompt_generator
    ):
    ...
    def test_workflow_with_contextual_technologies_only(
        self, requirement_parser, context_extractor, prompt_generator
    ):
    ...
    def test_workflow_with_ecosystem_preference(
        self, requirement_parser, context_extractor, prompt_generator
    ):
    ...
    def test_catalog_organization_with_real_data(self, prompt_generator):
        ...
        tech_context = TechContext(
            ...
            domain_context=DomainContext(
                primary_domain="web_api", sub_domains=[], complexity_indicators=[]
            ),
    ...
    def test_prompt_variations_generation(
        self, requirement_parser, context_extractor, prompt_generator
    ):
    ...
    def test_model_specific_optimization(self, prompt_generator):
        ...
        claude_optimized = prompt_generator.optimize_prompt_for_model(
            base_prompt, "claude-3"
        )
        bedrock_optimized = prompt_generator.optimize_prompt_for_model(
    ...
    def test_error_handling_with_missing_catalog(self, tmp_path):
        ...
        with patch(
            ...
            catalog_manager = IntelligentCatalogManager(
                catalog_path=missing_catalog_path
            )
            prompt_generator = ContextAwareLLMPromptGenerator(
