...
class TestAgentDataFormatter:
    ...
    def setup_method(self):
        ...
        self.mock_agent_role = AgentRole(
            ...
            decision_authority={"scope": "test_scope", "limits": [], "escalation_triggers": []},
            autonomy_level=0.8,
    ...
    def test_error_handling(self):
        ...
        with patch.object(self.formatter, '_format_agent_role', side_effect=Exception("Test error")):
            result = self.formatter.format_agent_system(
...
class TestTechStackEnhancer:
    ...
    def test_find_technologies_by_category(self):
        ...
        frameworks = self.enhancer._find_technologies_by_category(tech_stack, "agent_framework")
        assert "LangChain" in frameworks
        
        communication = self.enhancer._find_technologies_by_category(tech_stack, "communication")
...
class TestAgentRolesUIComponent:
    ...
    def test_render_system_overview(self, mock_metric, mock_columns, mock_subheader, mock_header):
...
class TestAgentSystemExporter:
    ...
    def test_export_to_markdown(self):
        ...
        result = self.exporter.export_to_markdown(self.mock_agent_display, "test_session")
    ...
    def test_create_deployment_blueprint(self):
        ...
        result = self.exporter.create_deployment_blueprint(self.mock_agent_display, "test_session")
...
class TestAgentDisplayIntegration:
    ...
    def test_end_to_end_agent_display_flow(self):
        ...
        markdown_export = self.exporter.export_to_markdown(agent_display, "integration_test")
