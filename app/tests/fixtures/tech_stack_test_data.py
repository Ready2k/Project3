...
class TechStackTestDataSets:
    ...
    def all_test_cases(
        self,
        aws_ecosystem_test_cases,
        azure_ecosystem_test_cases,
        gcp_ecosystem_test_cases,
        open_source_stack_test_cases,
        mixed_ecosystem_test_cases,
        domain_specific_test_cases,
        performance_test_cases,
    ) -> List[TechStackTestCase]:
...
class TechStackValidationMetrics:
    ...
    @staticmethod
    def validate_ecosystem_consistency(
        tech_stack: List[str], expected_ecosystem: str
    ) -> bool:
        ...
        other_cloud_techs = [
            ...
            if any(
                indicator in tech
                for other_indicators in ecosystem_indicators.values()
