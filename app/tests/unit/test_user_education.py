...
class TestUserEducationSystem:
    ...
    def test_generate_block_guidance(self):
        ...
        guidance = self.education_system.generate_user_guidance(
            decision, "test_session"
        )
    ...
    def test_generate_flag_guidance(self):
        ...
        assert (
            "sanitized" in guidance.content.lower()
            or "cleaned" in guidance.content.lower()
        )
        assert len(guidance.action_items) > 0
        assert guidance.appeal_info is not None
    ...
    def test_get_educational_content(self):
        ...
        purpose_content = self.education_system.get_educational_content(
            "system_purpose"
        )
    ...
    def test_get_acceptable_examples(self):
        ...
        process_examples = self.education_system.get_acceptable_examples(
            "process_automation"
        )
    ...
    def test_process_appeal(self):
        ...
        # Test valid decision
        result = self.education_system.process_appeal(
            appeal_id, "approved", "Looks legitimate"
        )
