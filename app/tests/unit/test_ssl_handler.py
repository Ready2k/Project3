...
class TestSSLHandler:
    ...
    async def test_validate_ssl_certificate_success(
        self, mock_validate_config, mock_get_cert
    ):
    ...
    @patch("app.services.ssl_handler.SSLHandler._get_certificate_info")
    @patch("app.services.ssl_handler.SSLHandler._validate_certificate_with_config")
    async def test_validate_ssl_certificate_validation_error(
        self, mock_validate_config, mock_get_cert
    ):
    ...
    def test_suggest_ssl_config_for_error(self):
        ...
        # Test self-signed certificate
        config = handler.suggest_ssl_config_for_error(
            "self_signed_certificate", "https://example.com"
        )
        ...
        # Test certificate verification failed
        config = handler.suggest_ssl_config_for_error(
            "certificate_verification_failed", "https://example.com"
        )
        assert "ca_cert_path" in config
    ...
    @patch("builtins.open")
    @patch("ssl.create_default_context")
    def test_validate_ca_certificate_file_success(
        self, mock_ssl_context, mock_open, mock_is_file, mock_exists
    ):
    ...
    def test_validate_ca_certificate_file_not_exists(self, mock_exists):
        ...
        is_valid, error = SSLHandler.validate_ca_certificate_file(
    ...
    @patch("pathlib.Path.is_file")
    @patch("builtins.open")
    def test_validate_ca_certificate_file_invalid_format(
...
class TestSSLValidationResult:
    ...
    def test_ssl_validation_result_success(self):
        ...
        result = SSLValidationResult(is_valid=True, certificate_info=cert_info)
