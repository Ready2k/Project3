...
class TestTechnologyCompatibilityValidator:
    ...
    def test_conflict_detection_cloud_providers(self, validator):
        ...
        tech_entries = {
            ...
            "Azure Blob Storage": Mock(
                ecosystem=EcosystemType.AZURE, license="Commercial"
            ),
        }
        ...
        cloud_conflicts = [
            c for c in conflicts if c.conflict_type == ConflictType.ECOSYSTEM_MISMATCH
        ]
    ...
    def test_conflict_resolution_with_priority(self, validator):
        ...
        validated, removed = validator._resolve_conflicts(
            tech_stack, conflicts, context_priority
        )
    ...
    def test_compatibility_score_calculation(self, validator):
        ...
        score = validator._calculate_compatibility_score(
    ...
    def test_generate_alternative_suggestions(self, validator):
        ...
        alternatives = validator._generate_alternative_suggestions(
            removed_technologies, tech_entries
        )
    ...
    def test_conflict_pattern_matching(self, validator):
        ...
        pattern = {"tech1_contains": ["aws"], "tech2_contains": ["azure"]}

        result = validator._matches_conflict_pattern(
            tech1, tech2, tech1_entry, tech2_entry, pattern
        )
        assert result is True

        # Test non-matching pattern
        pattern = {"tech1_contains": ["google"], "tech2_contains": ["azure"]}
    ...
    def test_choose_technology_to_remove(self, validator):
        ...
        tech_to_remove = validator._choose_technology_to_remove(
    ...
    def test_critical_conflict_handling(self, validator):
        ...
        validated, removed = validator._resolve_conflicts(
            tech_stack, [critical_conflict], context_priority
        )
