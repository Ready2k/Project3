...
class TestTemplateLoader:
    ...
    def test_get_templates_for_domain(self, template_loader):
        ...
        domain_templates = template_loader.get_templates_for_domain(
            "system_integration"
        )
...
class TestQuestionLoop:
    ...
    def test_calculate_confidence(self, question_loop):
        ...
        sparse_requirements = {"description": "Short"}  # Less than 10 chars
        ...
        medium_requirements = {"description": "Basic automation task"}  # > 10 chars
    ...
    @pytest.mark.asyncio
    async def test_generate_questions_with_missing_fields(
        self, question_loop, mock_session_store
    ):
    ...
    @pytest.mark.asyncio
    async def test_generate_questions_max_reached(
        self, question_loop, mock_session_store
    ):
    ...
    async def test_process_answers_success(self, question_loop, mock_session_store):
        ...
        answers = {"frequency": "daily", "data_sensitivity": "medium"}
    ...
    def test_merge_answers(self, question_loop):
        ...
        existing_requirements = {"description": "Test automation", "domain": "testing"}
...
class TestQuestion:
    ...
    def test_question_to_dict(self):
        ...
        assert (
            question_dict["question"] == "What is the frequency?"
        )  # UI expects "question" not "text"
...
class TestQAResult:
    ...
    def test_qa_result_creation(self):
        ...
        result = QAResult(complete=False, confidence=0.7, next_questions=questions)
    ...
    def test_qa_result_to_dict(self):
        ...
        result = QAResult(complete=True, confidence=0.9, next_questions=questions)
        ...
        assert (
            result_dict["next_questions"][0]["question"] == "Q1?"
        )  # UI expects "question" not "text"
