...
class TestConfidenceExtraction:
    ...
    def test_edge_cases_and_robustness(self):
        ...
        requirements = {
            "llm_analysis_confidence_level": {"result": {"confidence": 0.76}}
        }
        confidence = self.service._extract_llm_confidence(requirements)
    ...
    def test_malformed_json_edge_cases(self):
        ...
        requirements = {
            "llm_analysis_confidence_level": "broken{json confidence: 0.55 more}text"
        }
        confidence = self.service._extract_llm_confidence(requirements)
    ...
    def test_confidence_display_formatting(self):
        ...
        for confidence_value, expected_display in test_cases:
            ...
            ), f"Confidence {confidence_value} should format as {expected_display}, got {formatted}"
    ...
    def test_confidence_validation_comprehensive(self):
        ...
        for input_value, expected_output in boundary_tests:
            ...
            ), f"Input {input_value} should produce {expected_output}, got {confidence}"
        ...
        for invalid_value in invalid_tests:
            ...
            assert (
                confidence is None
            ), f"Invalid value {invalid_value} should return None, got {confidence}"
