...
class TestAgentNameGeneration:
    ...
    async def test_generate_agent_name_with_suffix(self, service):
        ...
        requirements = {"description": "Process data and manage user accounts"}
    ...
    async def test_generate_agent_name_action_fallback(self, service):
        ...
        requirements = {"description": "Create new records in the system"}
...
class TestUniqueAgentDesign:
    ...
    @pytest.mark.asyncio
    async def test_create_unique_single_agent_design(
        self, service, mock_autonomy_assessment, mock_pattern_match
    ):
        """Test creation of unique single agent design."""
        requirements = {"description": "User account management system"}
    ...
    @pytest.mark.asyncio
    async def test_create_unique_agents_different_indices(
        self, service, mock_autonomy_assessment
    ):
        """Test that different indices create different agent names."""
        requirements = {"description": "Data processing system"}
