...
class TestTechStackMonitor:
    ...
    def test_record_extraction_accuracy(self, monitor):
        ...
        accuracy_metrics = [
            m for m in monitor.metrics if m.name == "extraction_accuracy"
        ]
        ...
        inclusion_metrics = [
            m for m in monitor.metrics if m.name == "explicit_tech_inclusion_rate"
        ]
    ...
    def test_record_catalog_metrics(self, monitor):
        ...
        consistency_metrics = [
            m for m in monitor.metrics if m.name == "catalog_consistency_rate"
        ]
        ...
        # Check missing rate
        missing_metrics = [
            m for m in monitor.metrics if m.name == "catalog_missing_rate"
        ]
    ...
    def test_record_user_satisfaction(self, monitor):
        ...
        assert (
            len(satisfaction_metrics) == 4
        )  # relevance, accuracy, completeness, overall

        # Check overall satisfaction calculation
        overall_metrics = [
            m for m in monitor.metrics if m.name == "overall_satisfaction"
        ]
    ...
    def test_accuracy_alerts(self, monitor):
        ...
        accuracy_alerts = [
            a for a in monitor.alerts if a.category == "extraction_accuracy"
        ]
        inclusion_alerts = [
            a for a in monitor.alerts if a.category == "explicit_tech_inclusion"
        ]
    ...
    def test_catalog_alerts(self, monitor):
        ...
        consistency_alerts = [
            a for a in monitor.alerts if a.category == "catalog_consistency"
        ]
