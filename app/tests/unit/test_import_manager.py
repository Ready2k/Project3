...
class TestImportManager:
    ...
    def test_safe_import_with_context(self):
        ...
        with patch('importlib.import_module') as mock_import:
            ...
            result = self.import_manager.safe_import("test_module", context="Testing context")
    ...
    def test_require_service_not_registered(self):
        ...
        assert "Required service 'nonexistent_service' is not registered" in str(exc_info.value)
    ...
    def test_require_service_with_context(self):
        ...
        with pytest.raises(ServiceRequiredError) as exc_info:
            self.import_manager.require_service("nonexistent_service", context="Test context")
    ...
    def test_require_service_resolution_error(self):
        ...
        with patch.object(registry, 'has', return_value=True), \
             patch.object(registry, 'get', side_effect=ServiceNotFoundError("Service resolution failed")):
    ...
    def test_require_service_unexpected_error(self):
        ...
        with patch.object(registry, 'has', side_effect=RuntimeError("Unexpected error")):
    ...
    def test_optional_service_with_default(self):
        ...
        result = self.import_manager.optional_service("nonexistent_service", default=default_value)
    ...
    def test_optional_service_with_context(self):
        ...
        result = self.import_manager.optional_service("nonexistent_service", context="Test context")
    ...
    def test_optional_service_resolution_error(self):
        ...
        with patch.object(registry, 'has', return_value=True), \
             patch.object(registry, 'get', side_effect=RuntimeError("Resolution error")):
            
            result = self.import_manager.optional_service("failing_service", default="fallback")
    ...
    def test_try_import_service_registration_failure(self):
        ...
        with patch('importlib.import_module') as mock_import:
            ...
            with patch.object(registry, 'register_factory', side_effect=RuntimeError("Registration failed")):
    ...
    def test_is_available_class_not_found(self):
        ...
        with patch('importlib.import_module') as mock_import:
            ...
            result = self.import_manager.is_available("module_without_class", "NonexistentClass")
...
class TestUtilityFunctions:
    ...
    def test_import_optional_dependency_success(self):
        ...
        with patch('importlib.import_module') as mock_import:
            ...
            result = import_optional_dependency("optional_dep", feature_name="Optional Feature")
    ...
    def test_import_optional_dependency_failure(self):
        ...
        with patch('importlib.import_module') as mock_import:
            ...
            result = import_optional_dependency("missing_dep", feature_name="Missing Feature")
    ...
    def test_require_dependency_failure(self):
        ...
        with patch('importlib.import_module') as mock_import:
            ...
            assert "Required dependency 'missing_required' is not available" in str(exc_info.value)
    ...
    def test_create_fallback_service_neither_available(self):
        ...
        assert "Neither primary service 'primary_service' nor fallback service 'fallback_service'" in str(exc_info.value)
