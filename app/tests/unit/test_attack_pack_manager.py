...
from app.security.attack_pack_manager import (
    AttackPackManager, AttackPackValidationResult, get_attack_pack_manager
)
...
"""
    ...
    def test_activate_attack_pack_success(self, mock_get_config):
        ...
        with patch.object(self.manager, 'calculate_file_checksum', return_value="def456"):
    ...
    def test_rollback_attack_pack_success(self, mock_get_config):
        ...
        with patch.object(self.manager, 'activate_attack_pack', return_value=(True, "Success")):
    ...
    def test_cleanup_old_versions(self, mock_get_config):
        ...
        removed_count, removed_versions = self.manager.cleanup_old_versions(keep_count=3)
