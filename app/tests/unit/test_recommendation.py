...
class TestRecommendationService:
    ...
    def test_generate_recommendations_basic(
        self, service, sample_match_result, sample_requirements
    ):
    ...
    def test_generate_recommendations_multiple_matches(
        self, service, sample_requirements
    ):
    ...
    def test_determine_feasibility_automatable_low_complexity(
        self, service, sample_requirements
    ):
    ...
    def test_determine_feasibility_not_automatable_pattern(
        self, service, sample_requirements
    ):
    ...
    def test_analyze_complexity_factors(self, service):
        ...
        )  # 4 integrations (> 2 but <= 5 gives score 1)
        assert "workflow_complexity" in factors
        assert (
            factors["workflow_complexity"] == 1
        )  # 12 steps (> 8 but <= 15 gives score 1)
        assert "volume" in factors
        assert (
            factors["volume"] == 1
        )  # 15000 daily volume (> 5000 but <= 50000 gives score 1)
    ...
    def test_calculate_confidence_feasibility_adjustment(
        self, service, sample_match_result, sample_requirements
    ):
    ...
    def test_calculate_completeness_score(self, service):
        ...
        incomplete_score = service._calculate_completeness_score(
            incomplete_requirements
        )
    ...
    def test_suggest_tech_stack_basic(
        self, service, sample_match_result, sample_requirements
    ):
        """Test basic tech stack suggestion."""
        tech_stack = service._suggest_tech_stack(
            sample_match_result, sample_requirements
        )
    ...
    def test_suggest_tech_stack_database_integration(
        self, service, sample_match_result
    ):
        """Test tech stack suggestion with database integration."""
        requirements = {"integrations": ["database", "postgresql"]}
    ...
    def test_suggest_tech_stack_api_integration(self, service, sample_match_result):
        ...
        requirements = {"integrations": ["rest_api", "external_api"]}
    ...
    def test_suggest_tech_stack_high_volume(self, service, sample_match_result):
        ...
        requirements = {"volume": {"daily": 50000}}
    ...
    def test_suggest_tech_stack_compliance(self, service, sample_match_result):
        ...
        requirements = {"compliance": ["GDPR", "HIPAA"]}
    ...
    def test_generate_reasoning_comprehensive(
        self, service, sample_match_result, sample_requirements
    ):
        """Test comprehensive reasoning generation."""
        reasoning = service._generate_reasoning(
            sample_match_result, sample_requirements, "Yes", 0.85
        )
    ...
    def test_generate_reasoning_different_feasibilities(
        self, service, sample_match_result, sample_requirements
    ):
    ...
    def test_missing_requirements_fields(self, service, sample_match_result):
        ...
        recommendations = service.generate_recommendations(
            [sample_match_result], minimal_requirements
        )
...
class TestRecommendationServiceEdgeCases:
    ...
    def test_string_compliance_field(self, service):
        ...
        requirements = {"compliance": "GDPR"}  # String instead of list
