...
class TestPerformanceMetrics:
    ...
    def test_cache_metrics(self):
        ...
        assert (
            abs(metrics.get_cache_hit_rate() - 66.67) < 0.01
        )  # 2/3 * 100, approximately
...
class TestPerformanceOptimizer:
    ...
    def test_optimizer_initialization(self):
        ...
        optimizer = PerformanceOptimizer(
            cache_size=100, cache_ttl=300, max_workers=4, timeout_ms=50
        )
    ...
    async def test_parallel_detection(self):
        ...
        detector_funcs = [(mock_detector1, "Detector1"), (mock_detector2, "Detector2")]
