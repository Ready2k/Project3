...
class TestMarkdownExporter:
    ...
    def test_markdown_export_session_success(self, temp_export_path, sample_session):
        ...
        assert (
            "# Automated AI Assessment (AAA) - Automation Feasibility Report" in content
        )
...
class TestBaseExporter:
    ...
    def test_download_url_generation(self, temp_export_path):
        ...
        exporter = TestExporter(
            temp_export_path, base_url="https://example.com/exports/"
        )
...
class TestExportService:
    ...
    def test_export_session_json(self, temp_export_path, sample_session):
        ...
        file_path, download_url, file_info = service.export_session(
            sample_session, "json"
        )
