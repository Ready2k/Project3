...
class TestIntelligentCatalogManager:
    ...
    def sample_catalog_data(self):
        ...
        return {
            "metadata": {"version": "1.0.0", "total_technologies": 2},
            "technologies": {
                "fastapi": {
                    "id": "fastapi",
                    "name": "FastAPI",
    ...
    def test_initialization_with_existing_catalog(
        self, temp_catalog_path, mock_logger, sample_catalog_data
    ):
    ...
    def test_auto_add_technology(self, temp_catalog_path, mock_logger):
        ...
        tech_entry = manager.auto_add_technology(
    ...
    def test_technology_rejection(
        ...
        success = manager.reject_technology(
            "langchain", "test_reviewer", "Not suitable"
        )
        assert success
    ...
    def test_technology_update_request(
        self, temp_catalog_path, mock_logger, sample_catalog_data
    ):
        ...
        success = manager.request_technology_update(
            "langchain", "test_reviewer", "Needs more info"
        )
        assert success
    ...
    def test_get_technologies_by_category(
        self, temp_catalog_path, mock_logger, sample_catalog_data
    ):
    ...
    def test_get_technologies_by_ecosystem(
        self, temp_catalog_path, mock_logger, sample_catalog_data
    ):
