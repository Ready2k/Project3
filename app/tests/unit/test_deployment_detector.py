...
class TestDeploymentDetector:
    ...
    def test_normalize_base_url(self, detector):
        ...
        # Test with protocol
        assert detector._normalize_base_url("https://example.com/") == "https://example.com"
        assert detector._normalize_base_url("http://example.com") == "http://example.com"
    ...
    async def test_get_version_info_with_auth_fallback(self, detector):
        ...
        with patch('httpx.AsyncClient') as mock_client:
            ...
            version_info = await detector._get_version_info("https://jira.example.com", auth_headers)
    ...
    async def test_detect_deployment_cloud_success(self, detector):
        ...
        with patch('httpx.AsyncClient') as mock_client:
            ...
            assert deployment_info.base_url_normalized == "https://mycompany.atlassian.net"
    ...
    async def test_detect_deployment_with_context_path(self, detector):
        ...
        with patch('httpx.AsyncClient') as mock_client:
            ...
            deployment_info = await detector.detect_deployment("https://company.com/jira-app")
