...
class TestOvertInjectionDetector:
    ...
    def test_detector_initialization(self, detector):
        ...
        assert (
            len(detector.get_patterns()) == 4
        )  # Should have 4 overt injection patterns
    ...
    def test_pattern_14_ignore_instructions_detection(self, detector):
        ...
        for case in test_cases:
            ...
            if case["should_detect"]:
                ...
                ), f"Failed to detect attack in: {case['text']}"
                ...
                assert (
                    result.is_attack is False or result.confidence < 0.7
                ), f"False positive for: {case['text']}"
    ...
    def test_multiple_pattern_detection(self, detector):
        ...
        processed_input = ProcessedInput(
            ...
            language="en",
            length_stats={
                "chars": len(complex_attack),
                "words": len(complex_attack.split()),
            },
        )
    ...
    def test_confidence_calculation(self, detector):
        ...
        for case in test_cases:
            ...
            assert (
                result.confidence >= case["expected_min_confidence"]
    ...
    def test_confidence_threshold(self, detector):
        ...
        processed_input = ProcessedInput(
            ...
            language="en",
            length_stats={
                "chars": len(borderline_text),
                "words": len(borderline_text.split()),
            },
        )
