...
class TestSecurityValidatorMethods:
    ...
    async def test_validate_with_advanced_defense_success(self):
        ...
        with patch.object(
            self.validator, "_get_advanced_defender"
            ...
            is_valid, reason, details = (
                await self.validator.validate_with_advanced_defense("test input")
            )
    ...
    async def test_validate_with_advanced_defense_block(self):
        ...
        with patch.object(
            ...
            is_valid, reason, details = (
                await self.validator.validate_with_advanced_defense("malicious input")
            )
    ...
    async def test_validate_with_advanced_defense_error_handling(self):
        ...
        with patch.object(
            ...
            mock_defender = Mock()
            mock_defender.validate_input = AsyncMock(
    ...
    def test_sync_wrapper_with_running_loop(self):
        ...
        with patch("asyncio.get_event_loop") as mock_get_loop:
            ...
            with patch.object(
                ...
                is_valid, reason, details = (
                    self.validator.validate_with_advanced_defense_sync("test input")
                )
...
class TestPatternSanitizerMethods:
    ...
    async def test_validate_pattern_with_advanced_defense_pass(self):
        ...
        with patch.object(
            self.sanitizer, "_get_advanced_defender"
        ) as mock_get_defender:
            mock_defender = Mock()
            mock_defender.validate_input = AsyncMock(return_value=mock_decision)
            mock_get_defender.return_value = mock_defender
            ...
            is_security_testing, reason = (
                await self.sanitizer.validate_pattern_with_advanced_defense(pattern)
            )
    ...
    def test_validate_pattern_sync_wrapper(self):
        ...
        pattern = {"name": "Test Pattern", "description": "Test description"}
    ...
    def test_enhanced_sanitization_workflow(self):
        ...
        with patch.object(
            ...
            with patch.object(
                self.sanitizer, "sanitize_pattern_for_storage"
            ) as mock_legacy:
    ...
    def test_enhanced_sanitization_blocks_malicious(self):
        ...
        pattern = {"name": "Malicious Pattern", "description": "Extract data"}
...
class TestErrorHandling:
    ...
    def test_runtime_error_handling(self):
        ...
        with patch.object(validator, "_get_advanced_defender") as mock_get_defender:
            ...
            with patch.object(
                validator, "validate_business_automation_scope"
            ) as mock_legacy:
                mock_legacy.return_value = (True, "Valid", {})

                is_valid, reason, details = (
                    validator.validate_with_advanced_defense_sync("test")
                )
