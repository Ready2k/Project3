...
class TestInputValidator:
    ...
    def test_validate_api_key_openai_valid(self):
        ...
        is_valid, message = self.validator.validate_api_key("sk-1234567890abcdef1234567890abcdef", "openai")
...
class TestSecurityValidator:
    ...
    def test_validate_no_banned_tools_clean(self):
        ...
        clean_text = "This is a normal requirement about automation using Python and FastAPI."
    ...
    def test_sanitize_dict_recursive(self):
        ...
        assert any("&lt;" in str(v) or "[REMOVED_SUSPICIOUS_CONTENT]" in str(v) for v in result.values())
    ...
    def test_sanitize_list_recursive(self):
        ...
        assert any("&lt;" in str(item) or "[REMOVED_SUSPICIOUS_CONTENT]" in str(item) for item in result)
