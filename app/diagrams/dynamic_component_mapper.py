...
class DynamicComponentMapper:
    ...
    def __init__(self, technology_catalog_path: str = "data/technologies.json",
    ...
    def _load_technology_catalog(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.warning(f"Technology catalog not found: {self.technology_catalog_path}")
    ...
    def map_technology_to_component(self, technology_name: str, 
                                  provider_hint: Optional[str] = None) -> Tuple[str, str]:
        """
        ...
        logger.warning(f"No mapping found for technology: {technology_name}, using generic server")
    ...
    def _apply_mapping_rules(self, tech_name: str, 
                           tech_info: Optional[Dict[str, Any]]) -> Optional[ComponentMapping]:
