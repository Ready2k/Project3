...
class UserEducationDemo:
    ...
    def _display_security_decision(self, decision):
        ...
        print(f"🔍 Security Decision: {action_emoji.get(decision.action, '❓')} {decision.action.value.upper()}")
    ...
    def demo_appeal_system(self):
        ...
        success = self.defender.process_appeal(appeal_id, "approved", "Legitimate business request")
