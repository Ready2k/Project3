...
async def get_educational_content(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to retrieve educational content: {str(e)}"
        )
...
async def get_acceptable_examples(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to retrieve examples: {str(e)}"
        )
...
async def get_appeal_status(
    appeal_id: str, defender: AdvancedPromptDefender = Depends(get_defender)
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to retrieve appeal status: {str(e)}"
        )
...
async def get_pending_appeals(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to retrieve pending appeals: {str(e)}"
        )
...
async def process_appeal(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to process appeal: {str(e)}"
        )
