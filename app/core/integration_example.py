        ...
        try:
            ...
            if self.registry.has("config"):
                try:
                    ...
                    integration_results["configuration_access"][
                        "config_service"
                    ] = "available"
                except Exception as e:
                    integration_results["configuration_access"][
    ...
    try:
        ...
        if results["success"]:
            ...
            if settings_integration:
                ...
                print(
                    f"   LLM Provider: {settings_integration.get('llm_provider', 'unknown')}"
                )
                print(
                    f"   LLM Model: {settings_integration.get('llm_model', 'unknown')}"
                )
