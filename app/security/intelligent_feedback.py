...
class SecurityFeedbackGenerator:
    ...
    def __init__(self):
        ...
        self.safe_alternatives = {
            ...
            'security test': ['system validation', 'compliance check', 'system verification'],
            'security audit': ['compliance review', 'system assessment', 'quality review'],
    ...
    def generate_feedback(self, violations: Dict[str, List[str]]) -> str:
        ...
        if 'malicious_intent' in violations:
            return self._generate_malicious_intent_feedback(violations['malicious_intent'])
            ...
            if best_match:
                if best_match not in term_suggestions:
                    term_suggestions[best_match] = {
                        ...
                        'explanation': self.term_explanations.get(best_match, "This term has security implications.")
                    }
...
• Emphasize legitimate data processing workflows"""
    ...
    def extract_problematic_phrases(self, text: str, violations: Dict[str, List[str]]) -> List[Tuple[str, str]]:
        ...
        if 'malicious_intent' in violations:
            for term in violations['malicious_intent']:
                ...
                for match in matches:
                    ...
                    suggestion = f"Try: {', '.join(alternatives)}" if alternatives else "Use business-friendly terminology"
